                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <li>
                                            Nama Product : {{ $detail->product->name }} <br>
                                            Harga Product : Rp. {{ number_format($detail->product->harga) }} <br>
                                            Jumlah Beli : {{ $detail->jumlah }} <br>
                                            Subtotal : Rp. {{ number_format($detail->product->harga * $detail->jumlah) }} <br>
                                        </li>
                                        <br>    
                                        @endforeach
                                    </td>
