...
<head>
    <!-- Title -->
    <title>Test ADS X MSIB - @yield('title')</title>
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('logo/logo-siaps.png') }}" alt="">
                <img class="logo-compact" src="{{ asset('logo/logo-siaps.png') }}" alt="">
                {{-- <img class="brand-title" src="{{ asset('logo/logo-siaps.png') }}" alt=""> --}}
            </a>
