...
class CartController extends Controller
{
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('storecart', 'Produk berhasil ditambahkan ke keranjang');
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($cart->count() == 0) {
            return redirect('/cart')->with('kosongcart', 'Keranjang kosong');
        }
        ...
        foreach ($request->items as $item) {
            $stok = Product::find(Cart::find($item['id'])->id_product)->stok_awal;
        ...
        return redirect('/cart')->with('updatecart', 'Keranjang berhasil diupdate');
    }

    public function destroy($id)
    {
        Cart::destroy($id);
        return redirect()->back()->with('deletecart', 'Produk berhasil dihapus dari keranjang');
    }
    ...
    public function checkout()
    {
        ...
        // loop cek stok
        foreach ($cart as $c) {
            $stok = Product::find($c->id_product)->stok_awal;
